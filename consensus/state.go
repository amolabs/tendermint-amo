...
import (
	...
	cstypes "github.com/amolabs/tendermint-amo/consensus/types"
	tmevents "github.com/amolabs/tendermint-amo/libs/events"
...
func (cs *ConsensusState) handleMsg(mi msgInfo) {
	...
	case *VoteMessage:
		...
		if err == ErrAddingVote {
			...
			// a typical peer.
			// https://github.com/amolabs/tendermint-amo/issues/1281
		}
