...
// Examples
//
// - [Tendermint](https://github.com/amolabs/tendermint-amo/blob/master/rpc/core/routes.go)
// - [tm-monitor](https://github.com/amolabs/tendermint-amo/blob/master/tools/tm-monitor/rpc.go)
package rpc
