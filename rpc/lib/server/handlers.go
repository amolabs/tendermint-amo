...
import (
	...
	types "github.com/amolabs/tendermint-amo/rpc/lib/types"
)
...
// If some writes don't set it while others do, they may timeout incorrectly (https://github.com/amolabs/tendermint-amo/issues/553)
